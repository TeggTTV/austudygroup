			...
			<main className="grow mx-auto w-full max-w-3xl px-4 sm:px-6 lg:px-8 py-12 prose dark:prose-invert">
				<div className="rounded-2xl border border-border bg-surface p-8 shadow-sm space-y-6">
					...
					<div className="space-y-4 text-sm text-text-secondary leading-relaxed">
						<p>
							Welcome to AuStudyGroup. By accessing or using our
						...
						<p>
							Users must engage respectfully. Spam, offensive
							content, or unauthorized file sharing of copyrighted
							materials will result in immediate termination of
							access.
						</p>
						...
						<p>
							AuStudyGroup provides services &quot;as is&quot;. We
							are not responsible for schedule conflicts, academic
							results, or accuracy of shared study notes.
						</p>
					</div>
				</div>
			</main>
