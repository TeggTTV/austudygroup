...
export default function Home() {
	const { currentUser, loginUser, hydrated } = useAppContext();
				...
				<div className="mx-auto max-w-3xl px-6 text-center">
					...
					>
						<div className="flex items-center gap-2 rounded-xl border border-border bg-surface p-1.5 shadow-md focus-within:ring-2 focus-within:ring-primary/30 transition-all">
							...
							<button
								type="submit"
								className="rounded-lg bg-primary px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary-hover focus:outline-none transition-colors shrink-0"
							>
								Search
							</button>
						</div>
